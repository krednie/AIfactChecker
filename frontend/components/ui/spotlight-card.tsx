...
// Sets --x, --y, --xp, --yp on :root so ALL [data-glow] elements
// share ONE unified light source — the "grouped" effect.
...
export const GlowCard: React.FC<GlowCardProps> = ({
  ...
  // Each GlowCard syncs pointer locally so standalone usage works
  useEffect(() => {
    const sync = (e: PointerEvent) => {
      const { clientX: x, clientY: y } = e;
      if (cardRef.current) {
