...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-11 px-12 py-2",
        sm: "h-9 text-xs gap-1.5 px-8",
        lg: "h-12 rounded-full px-16",
        xl: "h-14 rounded-full px-20",
        xxl: "h-16 rounded-full px-24",
        icon: "size-11",
      },
    },
    defaultVariants: {
  ...
  return (
    <>
      <Comp
        ...
        style={{ paddingLeft: '3rem', paddingRight: '3rem', ...style }}
        {...props}
      >
        {/* Background glass layers — purely decorative, do NOT contain text */}
        ...
        {/* Text content — sits above glass layers */}
